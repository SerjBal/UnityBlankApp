...
Архитектурный шаблон для Unity, реализующий чистую архитектуру, паттерн MVP и другие практики разработки.
...
### Защита от взлома
- Зашифрованные типы данных (`SafeInt, SafeFloat, SafeString`)
